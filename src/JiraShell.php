...
class JiraShell
{
    ...
    public function __construct($queueFilePath = null, $envFilePath = null)
    {
        ...
        $envFilePath         = ($envFilePath === null) ? __DIR__ . '/env' : $envFilePath;
        ...
        foreach ($env as $item) {
            ...
            if (!isset($this->$property)) {
                throw new \RuntimeException('invalid env parameter ' . $property);
            }
            $this->$property = $value;
        }
    ...
    protected function sendIssue($json)
    {
        ...
        if (isset($obj->errors)) {
            throw new \RuntimeException('Errors in Jira Respose: ' . print_r($obj));
        }
